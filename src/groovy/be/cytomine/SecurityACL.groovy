...
//    }
    ...
    static public def checkGuest(SecUser user) {
       if (!user.admin && !user.getAuthorities().collect{it.authority}.contains("ROLE_USER") && !user.getAuthorities().collect{it.authority}.contains("ROLE_GUEST")) {
