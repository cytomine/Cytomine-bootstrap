...
//
    ...
    public ImagePlus getResult(int index) {
        return result[index];
    }
...
*/
		...
		this.result[0] = new ImagePlus(title+"-(Colour_1)",outputstack[0]);
		this.result[1] = new ImagePlus(title+"-(Colour_2)",outputstack[1]);
		this.result[2] = new ImagePlus(title+"-(Colour_3)",outputstack[2]);
	}
