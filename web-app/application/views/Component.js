var Component = Backbone.View.extend({
    ...
    addToMenu: function () {
        ...
        var button = ich.menubuttontpl({
            id: this.buttonAttr.elButton,
            route: this.buttonAttr.route,
            text: this.buttonAttr.buttonText
        }, true);
        $(this.buttonAttr.buttonWrapper).append(button);
        $("#" + this.buttonAttr.elButton).button({
            icons: {
                primary: this.buttonAttr.icon
            }
        });
