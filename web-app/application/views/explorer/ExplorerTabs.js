...
//        }
    ...
    addDashboard: function (dashboard) {
        ...
        //tabs.append(_.template("<li><a href='#tabs-review-<%= idProject %>' data-toggle='tab'><i class='icon-chevron-down' /> Review</a></li>", { idProject: window.app.status.currentProject}));
