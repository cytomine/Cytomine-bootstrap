    ...
    .controller("permissionCtrl", function ($scope,$location, $http, $resource,allUsers,permissionUrl,domainUrl,aclUrl,domainPermissionService,maskPermissionService) {
        ...
        $scope.getDomainLabel = function(item) {
            ...
            if(item==domainPermissionService.getDomainClassName("Project")) {
                label = "label-success";
            } else if(domainPermissionService.getDomainClassName("Ontology")) {
                label = "label-warning";
            } else if(domainPermissionService.getDomainClassName("Storage")) {
                label = "label-danger";
            }else if(domainPermissionService.getDomainClassName("Software")) {
                label = "label-info";
            }
            return label;
        };
