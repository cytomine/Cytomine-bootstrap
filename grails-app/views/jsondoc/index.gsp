...
<head>
    ...
    <script src="${resource(dir: 'jsondoc/js', file: 'bootstrap.min.js')}"></script>
    <script type="text/javascript" src="${resource(dir: 'jsondoc/js', file: 'handlebars-1.0.0.beta.6.js')}"></script>
    <script type="text/javascript" src="${resource(dir: 'jsondoc/js', file: 'jlinq.js')}"></script>
    <script type="text/javascript" src="${resource(dir: 'jsondoc/js', file: 'prettify.js')}"></script>
    <script src="${resource(dir: 'jsondoc/js', file: 'bootstrap-button.js')}"></script>

    <!-- Le styles -->
    <link rel="stylesheet" href="${resource(dir: 'jsondoc/css', file: 'bootstrap.min.css')}" type="text/css">
    <link rel="stylesheet" href="${resource(dir: 'jsondoc/css', file: 'font-awesome.css')}" type="text/css">
    ...
    <link rel="stylesheet" href="${resource(dir: 'jsondoc/css', file: 'bootstrap-responsive.min.css')}" type="text/css">
...
<div class="navbar navbar-fixed-top navbar-inverse">
    <div class="navbar-inner">
        <div class="container-fluid">
            <a class="brand" href="#">Cytomine API DOC</a>
