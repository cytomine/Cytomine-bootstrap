...
//        new Sql(dataSource).executeUpdate("CREATE TABLE keywords (key character varying(255))")
        ...
        def usersSamples = [
                ...
                [username : Infos.ANOTHERLOGIN, firstname : 'Just an', lastname : 'Admin', email : grailsApplication.config.grails.admin.email, group : [[name : "GIGA"]], password : Infos.ANOTHERPASSWORD, color : "#FF0000", roles : ["ROLE_USER"]]
        ]
